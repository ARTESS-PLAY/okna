...
function Consultation({ data }: { data?: any }) {
    ...
    const styles: { [key: string]: React.CSSProperties } = {
        img: {
            backgroundImage: `url(${data?.consultation.backgroundDesk})`,
        },
    };
            ...
            <div className="container col-12">
                    ...
                    <div className="form-container col-12">
                        <div className="form-layer">
                            <div className="form-header">
                                <h4 className="headline">{data?.consultation.title}</h4>
                                <p className="description">{data?.consultation.description}</p>
                            </div>
                ...
                <div className="form-mobile">
                    <div className="section-main-img col-7 col-md-12">
                        <img
                            className="col-12"
                            src={data?.consultation.mobileBg}
                            alt="main image"
                        />
