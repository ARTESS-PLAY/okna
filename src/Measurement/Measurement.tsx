...
import '../Forms.scss';
import TelIcon from '../img/phone-btn.svg';
...
function Measurement({ data }: { data?: any }) {
    ...
    const handleSubmit = (): void => {
        if (name.trim().length > 0 && phone.trim().length > 0 && !validatePhone()) {
    ...
    const styles: { [key: string]: React.CSSProperties } = {
        img: {
            backgroundImage: `url(${data?.measurement.backgroundDesk})`,
        },
    };
            ...
            <div className="container col-12">
                    ...
                    <div className="form-container col-12">
                        <div className="form-layer">
                            <div className="form-header">
                                <h4 className="headline">{data?.measurement?.title}</h4>
                                <p className="description">{data?.measurement.description}</p>
                            </div>
                            ...
                            <a className="col-12" onClick={() => handleSubmit()}>
                                <button className="btn btn-filled col-12">
                                    <img className="icon" src={TelIcon} alt="phone icon" />{' '}
                                    {data?.measurement.buttonText}
                                </button>
                            </a>
                ...
                <div className="form-mobile">
                    <div className="section-main-img col-7 col-md-12">
                        <img className="col-12" src={data?.measurement.mobileBg} alt="main image" />
                    ...
                    <div className="form-container__mobile">
                        <div className="form-layer">
                            ...
                            <a className="btn-submit col-12" onClick={() => handleSubmit()}>
                                <button className="btn btn-filled col-12">
                                    <img className="icon" src={TelIcon} alt="phone icon" />{' '}
                                    {data?.measurement.buttonText}
                                </button>
                            </a>
                            <a className="btn-submit__mobile col-12" onClick={() => handleSubmit()}>
                                <button className="btn btn-filled col-12">
                                    <img className="icon" src={TelIcon} alt="phone icon" />
                                    {data?.measurement.buttonText}
                                </button>
